export class Vehicle{
    ...
    constructor(pLicensePlate:string,pBrandId:number,pTypeId:number,
       pAreaId:number,pModelId:number,pYear:number,
        pColor:string,pFuelTypeId:number,pEngineNumber:string,pSerialNumber:string, pStateId:number, pEngineTypeId:number,pBelongingId){
