...
@Component({
  selector: 'cad-edit-functionaries',
  templateUrl: './edit-functionaries.component.html',
  styleUrls: ['./edit-functionaries.component.scss'],
})
export class EditFunctionariesComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder) {
    this.funcionariesForm = this.fb.group({
      ...
      maternalName: new FormControl('', [Validators.required]),
